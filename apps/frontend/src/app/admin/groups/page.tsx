...
async function createGroupAction(formData: FormData): Promise<void> {
  "use server";
...
async function removeGroupAction(groupId: string): Promise<void> {
  "use server";
    ...
    return (
      <div className="space-y-6">
        <SpaceManagementHeader
          ...
          users={users}
          createSpaceAction={createGroupAction}
        />
