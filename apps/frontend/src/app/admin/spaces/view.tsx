...
import { SpaceManagementHeader } from "@/features/admin/spaces/components/space-management-header";
import { SpaceList } from "@/features/admin/spaces/components/space-list";
import {
  addMemberAction,
  createSpaceAction,
